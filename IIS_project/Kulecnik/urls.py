...
urlpatterns = [
    ...
    path('<int:tournament_id>/confirm_s/<int:player_id>/', views.confirm_player, name='confirm_player'),
    path('<int:tournament_id>/deny_s/<int:player_id>/', views.deny_player, name='confirm_player'),
