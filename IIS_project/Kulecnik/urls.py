...
urlpatterns = [
    ...
    path('tournament_s/<int:row_id>/refconfirm/<int:ref_id>/', views.confirm_referee, name='confirm_referee'),
    path('tournament_t/<int:row_id>/refreg/<int:ref_id>/', views.reg_referee_t, name='reg_referee'),
    path('tournament_t/<int:row_id>/refunreg/<int:ref_id>/', views.unreg_referee_t, name='unreg_referee'),
    path('tournament_t/<int:row_id>/refconfirm/<int:ref_id>/', views.confirm_referee_t, name='confirm_referee'),
    ...
    path('games_s/<int:tournament_id>/', views.list_games_s, name='list_games_s'),
    path('games_t/<int:game_id>/select_winner/<int:team_id>/', views.select_winner_t, name='select_winner_t'),
    path('games_s/<int:game_id>/select_winner/<int:player_id>/', views.select_winner_s, name='select_winner_s')
